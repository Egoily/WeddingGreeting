...
{
    /// <summary>
    /// Class extending the <see cref="ColorEditor"/> which adds the capability to also change the
    ...
    public class ColorEditorEx : ColorEditor
    {
        ...
        /// <summary>
        /// Wrapper for the private ColorUI class nested within <see cref="ColorEditor"/>. It
        /// publishes its internals via reflection and adds a <see cref="TrackBar"/> to adjust teh
        /// alpha value.
        /// </summary>
        public class ColorUIWrapper
        {
            ...
            /// <summary>
            /// The control to be shown when a color is edited. The concrete type is ColorUI which
            /// is privately hidden within System.Drawing.Design.
            /// </summary>
        ...
        /// <summary>
        /// Paints some extra background to better visualize transulcent colors.
        /// </summary>
